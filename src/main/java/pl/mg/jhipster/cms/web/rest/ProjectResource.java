...
import pl.mg.jhipster.cms.repository.search.ProjectSearchRepository;
import pl.mg.jhipster.cms.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link pl.mg.jhipster.cms.domain.Project}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProjectResource {
    ...
    public List<Project> searchProjects(@RequestParam String query) {
        ...
        return StreamSupport.stream(projectSearchRepository.search(query).spliterator(), false).collect(Collectors.toList());
    }
}
